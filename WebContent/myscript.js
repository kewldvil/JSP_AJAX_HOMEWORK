            ...
            .ready(
                function() {
                    ...
                    function updateStatus(selector) {
                        ...
                        $
                            .post(
                                ...
                                function() {
                                    selector.children().attr(
                                            "src") == "img/active.png" ? selector
                                        .children()
                                        .attr("src",
                                            "img/inActive.png") : selector
                                        .children()
                                        .attr(
                                            "src",
                                            "img/active.png");
                    ...
                    function addStudent(){
                        ...
                        $.post('/insertStudent.pheak',{id:id,name:name,gender:gender,university:university,classes:classes}, function(data, textStatus, xhr) {
